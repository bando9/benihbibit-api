import { SeedProductsType } from "./schema-type";

export const products: SeedProductsType = [
  {
  ...
  },
  {
    ...
    description:
      "Benih Zinnia warna-warni dengan bunga besar dan tahan panas. Cocok untuk taman tropis Indonesia. Isi 30 biji dalam kemasan foil ziplock.",
  },
];
